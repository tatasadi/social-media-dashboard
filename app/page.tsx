...
export default function Home() {
  ...
  return (
    <main className="relative flex h-full min-h-screen w-full max-w-7xl flex-col items-center bg-white px-6 pt-9 text-black lg:min-h-0 lg:px-40 dark:bg-black dark:text-white">
      ...
      <div className="relative z-10 w-full">
        <div className="flex w-full flex-col sm:flex-row sm:justify-between">
          <div className="border-gray mb-4 border-b pb-6 sm:border-none">
            <h1 className="mb-1 text-2xl font-bold leading-normal">
        ...
        <h2 className="text-dark-grayish-blue mb-[1.69rem] mt-[2.88rem] text-2xl font-bold leading-normal">
          {" "}
          Overview - Today
        </h2>
